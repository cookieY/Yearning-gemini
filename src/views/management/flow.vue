            ...
            <Tabs value="preview">
              <TabPane label="预览编辑" name="preview">
                ...
                <template v-if="is_tpl_edit">
                  <Button type="text" size="small" class="margin-left-10" @click="position_adjustment(true)">向后移动
                  </Button>
                  <Button type="info" size="small" @click="edit_tpl_save" class="margin-left-10">保存</Button>
                  <Button type="text" size="small" class="margin-left-10" @click="position_adjustment(false)">向前移动
                  </Button>
                </template>
